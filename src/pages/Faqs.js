...
function Faqs() {
  return (
    <VStack width="80%" >
        <Text textAlign={["center", "center", "center", "start"]} fontSize={["18px", "20px", "24px", "2rem"]}>
        Frequently Asked Questions About Our Analysis services
        </Text>
        <VStack>
